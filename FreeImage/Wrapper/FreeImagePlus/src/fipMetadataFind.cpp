...
FI_BOOL fipMetadataFind::isValid() const {
...
FI_BOOL fipMetadataFind::findFirstMetadata(FREE_IMAGE_MDMODEL model, fipImage& image, fipTag& tag) {
	FITAG *firstTag = NULL;
...
FI_BOOL fipMetadataFind::findNextMetadata(fipTag& tag) {
	FITAG *nextTag = NULL;
