...
_convertCMYKtoRGBA(unsigned width, unsigned height, BYTE* line_start, unsigned pitch, unsigned samplesperpixel) {
	const FI_BOOL hasBlack = (samplesperpixel > 3) ? TRUE : FALSE;
...
FIBITMAP * DLL_CALLCONV
FreeImage_ConvertFromRawBitsEx(FI_BOOL copySource, BYTE *bits, FREE_IMAGE_TYPE type, int width, int height, int pitch, unsigned bpp, unsigned red_mask, unsigned green_mask, unsigned blue_mask, FI_BOOL topdown) {
	FIBITMAP *dib = NULL;
...
FIBITMAP * DLL_CALLCONV
FreeImage_ConvertFromRawBits(BYTE *bits, int width, int height, int pitch, unsigned bpp, unsigned red_mask, unsigned green_mask, unsigned blue_mask, FI_BOOL topdown) {
...
void DLL_CALLCONV
FreeImage_ConvertToRawBits(BYTE *bits, FIBITMAP *dib, int pitch, unsigned bpp, unsigned red_mask, unsigned green_mask, unsigned blue_mask, FI_BOOL topdown) {
